...
//        imprimir(animais, (Animal animal) -> animal.podeNadar());

//        Consumer<Animal> consumer = animal -> System.out.println(animal);
...
//    private static void imprimir(List<Animal> animais, Predicate<Animal> verificador) {
